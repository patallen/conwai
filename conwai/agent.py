...
_TICK_TEMPLATE = (PROMPTS_DIR / "tick.md").read_text()
...
class Agent:
    ...
    _inbox: list[tuple[str, str, int]] = field(default_factory=list, init=False, repr=False)
    ...
    # Template used by brain for tick messages
    _TICK_TEMPLATE: str = field(default=_TICK_TEMPLATE, init=False, repr=False)
